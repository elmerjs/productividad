...
<title>Bonificación - Formulario de Creación Artística</title>
    </head>
<body>
    <div class="container mt-5">
        <div class="modal-content p-4">
            <h5 class="modal-title mb-3">Bonificaicón - Obra de Creación Artística</h5>
    ...
    <input type="text" id="numeroOficio" name="numeroOficio" class="form-control" placeholder="Número de oficio">
            ...
            <div class="radio-group">
                <label>Impacto:</label>
            <div class="radio-group">
                <label><input type="radio" name="impacto" value="internacional" required> Regional</label>
                <label><input type="radio" name="impacto" value="local" required> Local</label>
            </div>
            </div>
                                    </div>

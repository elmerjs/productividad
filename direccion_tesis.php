...
<head>
    ...
    <title>Dirección de Tesis | CIARP</title>
    ...
    <style>
        ...
        .datos-container {
            ...
            padding: 12px;
            border-radius: 8px;
            border-left: 4px solid #10b981; /* Verde Bonificación */
            min-height: 45px;
            display: flex;
            align-items: center;
            color: #334155;
...
<body>
    <div class="container">
        <div class="card-custom">
            <div class="text-center mb-2">
                <span class="badge-bono"><i class="fas fa-scroll mr-1"></i> Módulo de Bonificación</span>
            </div>
            ...
            <form action="guardar_direccion_tesis.php" method="post">
                ...
                <div class="section-title">Detalles del Trabajo Dirigido</div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Título del Producto / Trabajo:</label>
                        <input type="text" class="form-control shadow-sm" name="producto" id="producto" placeholder="Nombre de la tesis o trabajo de grado" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Tipo de Dirección:</label>
                        <select id="tipo_direccion" name="tipo_direccion" class="custom-select shadow-sm" onchange="actualizarPuntaje()">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="nombre_estudiante" name="nombre_estudiante" class="form-control shadow-sm" required>
                    </div>
                </div>
                ...
                <div class="form-row mb-3">
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control shadow-sm" name="fecha_sustentacion" id="fecha_sustentacion" required>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        <label>Resolución de Trabajo de Grado:</label>
                        <input type="text" class="form-control shadow-sm" name="resolucion" id="resolucion" placeholder="Nro. Resolución">
                    </div>
                </div>
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-md-4 text-center">
                        <label class="text-success fw-bold">Puntaje Total (Puntos)</label>
                        ...
                        <small class="text-muted">Valor automático según el tipo de dirección.</small>
                    </div>
                </div>
    ...
    <script>
        // Lógica de puntaje según tipo de dirección
        function actualizarPuntaje() {
            const tipo = document.getElementById("tipo_direccion").value;
            let puntaje = 0;

            switch(tipo) {
                case "maestria": puntaje = 36; break;
                case "doctorado": puntaje = 72; break;
                case "posdoctorales": puntaje = 120; break;
                default: puntaje = 0;
            }
            document.getElementById("puntaje").value = puntaje;
        }

        // Búsqueda AJAX de datos del profesor

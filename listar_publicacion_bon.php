...
";
    ...
    $identificadores_result = $conn->query("SELECT DISTINCT identificador_completo FROM publicacion_bon");
    $identificadores = [];
    ...
    <head>
        ...
        <title>publicaciones_bonif</title>
...
<td title="<?php echo $row['DEPARTAMENTO']; ?>">
    ...
    ?>
               ...
               <td>
    <?php
        // Combinar lugar y fecha en un solo texto
        echo $row['lugar_publicacion'] . ' : ' . $row['fecha_publicacion'];
    ?>
</td>
...
<div id="modalpb" class="modal">
    ...
    <div id="modalCuadrospb" class="modal">
        ...
        language: {
            ...
            $("#openModalpb").click(function() {
                $("#modalpb").css("display", "block");
            });

            // Abrir el modal para generar Cuadros
            $("#openModalCuadrospb").click(function() {
                $("#modalCuadrospb").css("display", "block");
            });

            // Cerrar los modales
            $(".close").click(function() {
                $("#modalpb").css("display", "none");
            });

            $(".close-cuadros").click(function() {
                $("#modalCuadrospb").css("display", "none");
            });

            // Cerrar los modales si se hace clic fuera de ellos
            $(window).click(function(event) {
                if ($(event.target).is("#modalpb")) {
                    $("#modalpb").css("display", "none");
                }
                if ($(event.target).is("#modalCuadrospb")) {
                    $("#modalCuadrospb").css("display", "none");
                }
            });

...
<head>
    ...
    <title>Trabajo de Carácter Científico (bonif)</title>
    <!-- CSS de Bootstrap -->
...
<body>
    <div class="container mt-5">
        <h1>Bonificación - Trabajo de Carácter Científico</h1>
        <!-- Formulario -->
        <form action="guardar_trabajo_bon.php" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="difusion" id="difusion">
        ...
        <option value="LOCAL">Local</option>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                   ...
                   <select class="form-control" name="finalidad" id="finalidad">
    <option value="didactivo">Didáctico</option>
...
<script>
    // Obtener referencias a los campos de los evaluadores y puntaje total
    const puntajeInput = document.getElementById('puntaje');

    function calcularPuntajeTotal() {
        // Obtener los valores de los evaluadores y el número de profesores
        const eval1 = parseFloat(evaluador1Input.value) || 0;
        const eval2 = parseFloat(evaluador2Input.value) || 0;
        const autores = parseInt(hiddenInput.value) || 1;

        // Calcular el promedio de los evaluadores y el puntaje base
        const promedioEvaluadores = (eval1 + eval2) / 2;
        const puntajeBase = promedioEvaluadores * 48; // Multiplicador 48

        let puntajeFinal;

        // Aplicar reglas según el número de autores
        if (autores <= 3) {
        ...
        // Redondear hacia abajo y asignar el valor al campo de puntaje
        puntajeInput.value = Math.floor(puntajeFinal) / 100;
    }

    // Agregar el cálculo de puntaje total cuando se modifiquen los evaluadores o el número de profesores
    evaluador1Input.addEventListener('input', calcularPuntajeTotal);
    evaluador2Input.addEventListener('input', calcularPuntajeTotal);
    hiddenInput.addEventListener('input', calcularPuntajeTotal);
</script>

...
try {
    ...
    $sql_creacion = "INSERT INTO ponencias_bon (
                        identificador_completo, numeroOficio, fecha_solicitud, difusion, 
                         producto, nombre_evento,  fecha_evento, lugar_evento, 
    ...
    for ($i = 1; $i <= $numero_profesores; $i++) {
        ...
        $sql_creacion_profesor = "INSERT INTO ponencias_bon_profesor (id_ponencias_bon, documento_profesor) 
                                  VALUES (?, ?)";

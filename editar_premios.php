...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM premios WHERE id = ?";
...
<div class="container">
    <h4 class="mb-4">Editar Solicitud premios</h4>
    <form action="actualizar_solicitud_premios.php" method="post">
...
<input type="hidden" name="id_solicitud" value="<?= $premio_id ?>">
        <div class="col-md-12 form-container">
            <div id="profesores-container" class="form-control">
        ...
        <div class="row mb-3">
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="identificador" name="identificador" value="<?= $premio['identificador'] ?>" required>
            </div>
            <div class="col-md-2">
                <label for="oficio" class="form-label">Oficio:</label>
                <input type="text" class="form-control" id="oficio" name="oficio" value="<?= $premio['numero_oficio'] ?>" required>
            </div>
                        <div class="col-md-8">
                <label for="nombre_evento" class="form-label">nombre evento:</label>
                <input type="text" class="form-control" id="nombre_evento" name="nombre_evento" value="<?= $premio['nombre_evento'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
             <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="ambito" name="tipo" value="<?= $premio['ambito'] ?>" required>
            </div>
            <div class="col-md-3">
                <label for="categoria" class="form-label">categoría:</label>
                <input type="text" class="form-control" id="categoria" name="categoria" value="<?= $premio['categoria_premio'] ?>" required>
            </div>
            <div class="col-md-2">
                <label for="nivel_ganado" class="form-label">nivel ganado:</label>
                <input type="text" class="form-control" id="nivel_ganado" name="nivel_ganado" value="<?= $premio['nivel_ganado'] ?>" required>
            </div>
                 <div class="col-md-2">
                <label for="lugar_fecha" class="form-label">lugar y fecha:</label>
                <input type="text" class="form-control" id="lugar_fecha" name="lugar_fecha" value="<?= $premio['lugar_fecha'] ?>" required>
            </div>
               <div class="col-md-3">
                <label for="numero_profesores" class="form-label">numero profesores:</label>
                <input type="text" class="form-control" id="numero_profesores" name="numero_profesores" value="<?= $premio['numero_profesores'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
             <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="autores" name="autores" value="<?= $premio['autores'] ?>" required>
            </div>
       
             <div class="col-md-3">
                <label for="puntaje" class="form-label">Puntaje:</label>
                <input type="text" class="form-control" id="puntaje" name="puntaje" value="<?= $premio['puntos'] ?>" required>
            </div>
        </div>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tipo_traduccion = filter_input(INPUT_POST, 'tipo_traduccion', FILTER_SANITIZE_STRING);
    ...
    $sql = "INSERT INTO traduccion_libros (
                identificador,
                numero_oficio,
                fecha_solicitud,
                producto,
                ...
                puntaje,
                estado,
                tipo_traduccion, tipo_productividad
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
            ...
            for ($i = 1; $i <= $numero_profesores; $i++) {
                ...
                if (!empty($id_profesor)) {
                    $sql_profesor = "INSERT INTO traduccion_profesor (id_traduccion, id_profesor) VALUES (?, ?)";

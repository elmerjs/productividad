...
<div class="container">
    <h4 class="mb-4">Editar Solicitud Libros</h4>
    <form action="actualizar_solicitud_libros.php" method="post">
        <input type="hidden" name="comision_id" value="<?= $libro_id ?>">
...
<input type="hidden" name="id_solicitud" value="<?= $libro_id ?>">
        ...
        <div class="row mb-3">
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="identificador" name="identificador" value="<?= $libro['identificador'] ?>" required>
            </div>
            <div class="col-md-2">
                <label for="oficio" class="form-label">Oficio:</label>
                <input type="text" class="form-control" id="oficio" name="oficio" value="<?= $libro['numero_oficio'] ?>" required>
            </div>
                        <div class="col-md-8">
                <label for="producto" class="form-label">Producto:</label>
                <input type="text" class="form-control" id="producto" name="producto" value="<?= $libro['producto'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
             <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="tipo" name="tipo" value="<?= $libro['tipo_libro'] ?>" required>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <label for="mes_ano" class="form-label">Mes y año edición:</label>
                <input type="text" class="form-control" id="mes_ano" name="mes_ano" value="<?= $libro['mes_ano_edicion'] ?>" required>
            </div>
                 <div class="col-md-2">
                <label for="editorial" class="form-label">Editorial:</label>
                <input type="text" class="form-control" id="editorial" name="editorial" value="<?= $libro['nombre_editorial'] ?>" required>
            </div>
               <div class="col-md-3">
                <label for="tiraje" class="form-label">Tiraje:</label>
                <input type="text" class="form-control" id="tiraje" name="tiraje" value="<?= $libro['tiraje'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="evaluador1" name="evaluador1" value="<?= $libro['evaluacion_1'] ?>" required>
            </div>
            <div class="col-md-3">
                <label for="evaluador2" class="form-label">Evaluador 2:</label>
                <input type="text" class="form-control" id="evaluador2" name="evaluador2" value="<?= $libro['evaluacion_2'] ?>" required>
            </div>
             <div class="col-md-3">
                <label for="puntaje" class="form-label">Puntaje:</label>
                <input type="text" class="form-control" id="puntaje" name="puntaje" value="<?= $libro['puntaje_final'] ?>" required>
            </div>
        </div>
